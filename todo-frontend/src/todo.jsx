            ...
            <div className="col-md-6 w-100">
                ...
                <ul className="list-group">
                    ...
                    <div className="d-flex gap-2">
                        { editId == -1 ?<button className="btn btn-dark" onClick={() => handleEdit(item)} >Edit</button>:<button className="btn btn-dark" onClick={handleUpdate} >Update</button>}
                        { editId == -1 ? <button className="btn btn-dark" onClick={() => handleDelete(item._id)}>Delete</button> :
